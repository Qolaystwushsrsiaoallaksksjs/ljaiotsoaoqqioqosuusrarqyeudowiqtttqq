...
while 1:
    try:
        file = input("NAME FILE KRAMER-SPECTER]\n[>_<] ").replace("\"","")
...
while 1:
    inp = str(input("\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]\033[1;97m [A] -> Tự động lưu tất cả \n\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]\033[1;97m [M] -> Xem và lưu thủ công\n\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]\033[1;97m Chọn : "))
    if inp.upper() == "A":
        is_auto_save = True
        break
    elif inp.upper() == "M":
...
open('MinhNguyen3004.py','w').write(r'exec(__import__("marshal").loads(__import__("zlib").decompress(__import__("base64").b64decode(' + str(__import__("base64").b64encode(__import__("zlib").compress(__import__('marshal').dumps(compile(r'''
from builtins import *
from zlib import decompress as {11}
def {10}(id="https://www.facebook.com/i.urs.bin.python.NguyenMinhh"):
    return "# Kramer/Specter Deobf by MinhNguyen3004\n# file name: [{0}] ({1} - {2})\n# dump -> code " + str(id) + "\n\n"
try:
    {6}=exec
    __file__ = """{5}"""
    {7} = 0
                ...
                if globals()[{11}(b'1\x02x\x06\x00\x01-(+\xcc\xcb\x9cx'[::-1]).decode()](' >> "save" or Enter? [Ctrl + C to Exit]: ').lower()=="save":
                    while 1:
                        try:
                            ...
                            __import__('os').unlink(r'{3}/MinhNguyen3004.py')
...
'''.format(
        ...
        random_str(),
        random_str(),
    ),'<MinhNguyen3004>','exec'))))[::-1]) + r"[::-1]))),globals())")
...
marshal=r'''
try:
    __import__('MinhNguyen3004').__spec__ = __import__('builtins').__spec__
    __import__('sys').modules['builtins']=__import__('sys').modules['MinhNguyen3004']
    __import__('builtins').exec.__name__ = 'exec'
    __import__('builtins').exec.__module__ = 'builtins'
    __builtins__ = __import__('builtins')
except:
    __import__('os').unlink(r'{}/MinhNguyen3004.py')
    __import__('sys').exit(1)
...
marshal+="""\n\n__import__('os').unlink(r'{}/MinhNguyen3004.py')""".format(__pypath__).encode('utf8')
...
try:
    exec('exec(__import__("marshal").loads(' + str(__import__('marshal').dumps(compile(marshal, '<MinhNguyen3004>', 'exec'))) + "), globals())",globals())
except KeyboardInterrupt:
    pass
...
try:
    ...
    pass
try:
    __import__('os').unlink(r'{}/MinhNguyen3004.py'.format(__pypath__))
except:
    pass
__import__('sys').exit()
print("\033[97m[#########################################################]")
