import ast, random, math, io, string, tokenize
__import__('os').system("cls" if __import__('os').name == "nt" else "clear")
print("\033[1;97m[—————[COPYRIGHT : MINHNGUYEN3004 AND TUNGUYEN2712]———————]")

print("\033[1;97m[—————————————————————[OBFUSCATION]———————————————————————]")
print("\033[1;97m[═════════════════════════════════════════════════════════]")
bz2 = lambda in_: __import__('bz2').compress(in_)
lzm = lambda in_: __import__('lzma').compress(in_)
zlb = lambda in_: __import__('zlib').compress(in_)
b85 = lambda in_: __import__('base64').b85encode(in_)
b64 = lambda in_: __import__('base64').b64encode(in_)
b64 = lambda in_: __import__('base64').b64encode(in_)
b64 = lambda in_: __import__('base64').b64encode(in_)
b64 = lambda in_: __import__('base64').b64encode(in_)
b64 = lambda in_: __import__('base64').b64encode(in_)
...
b64 = lambda in_: __import__('base64').b64encode(in_)
b64 = lambda in_: __import__('base64').b64encode(in_)
b32 = lambda in_: __import__('base64').b32encode(in_)
b16 = lambda in_: __import__('base64').b16encode(in_)
mar = lambda in_: __import__('marshal').dumps(compile(in_,'<MinhNguyen3004>','exec'))
bz2 = lambda in_: __import__('bz2').compress(in_)
lzm = lambda in_: __import__('lzma').compress(in_)
zlb = lambda in_: __import__('zlib').compress(in_)
b85 = lambda in_: __import__('base64').b85encode(in_)
...
for i in range(10000):
    antipycdc += "1/int(0),"
antipycdc = f"""try:
    MinhNguyen3004=({antipycdc})
    def ___(__, _: str, MinhNguyen3004 = True, deptrai = True) -> None:pass
except:pass"""
anti = f"""try:pass
except:pass
else:pass
...
class ObfString:
    def __init__(self, content: str, clean = True, obfcontent = True) -> None:
...
{self.content}""".strip()
    ...
    def CleanCode(self):
            ...
            self.CompressCode()
    def Tochuc(self):
        boc_marshal = Obfuscation(self.OBF_Builtins('\n'.join(self.strings) + '\n' + self.content))
        Error = """class ERROR(MemoryError):0"""
    ...
    def OBF_Marshal(self, code):
        return __import__('marshal').dumps(compile(code.encode(), '<_minhnguyen-ngocvu>', 'exec'))
    ...
    def _adv_str(self, string):
        ...
        if (string.replace('b','').replace('u','').replace('r','').replace('f','')[0] == '"' and string.split('"')[0].count('f') != 0) or (string.replace('b','').replace('u','').replace('r','').replace('f','')[0] == "'" and string.split("'")[0].count('f') != 0):
            return var, False
        return var, True
class Formatter(__import__('ast').NodeTransformer):
    def visit_JoinedStr(self,node: __import__('ast').JoinedStr) -> __import__('ast').Call:return __import__('ast').Call(func=__import__('ast').Attribute(value=__import__('ast').Constant(value='{}'*len(node.values)), attr="format", ctx=__import__('ast').Load()),args=[value.value if isinstance(value, __import__('ast').FormattedValue) else value for value in node.values],keywords=[],)
def Import(code):
    imports_ = []
    tree = __import__('ast').parse(code)
    for node in __import__('ast').walk(tree):
...
def create_class(code):
    ...
    for i in classes:
        newcode += f"class {i}:\n    def __init__(self):\n"
O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00OO0O00OO0O00OO0O00OO0O00O失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊"+"".join(random.choice(string.ascii_lowercase + string.ascii_uppercase) for i in range(random.randint(8, 200))) for i in range(random.randint(5, 150))]
        for i in funcs:
            newcode += f"        self.{i}()\n"
        for i in funcs:
            newcode += f"    def {i}(self, {', '.join([''.join(random.choice(string.ascii_lowercase + string.ascii_uppercase) for i in range(random.randint(5, 200))) for i in range(random.randint(1, 70))])}):\n        return self.{random.choice(funcs)}()\n"
    newcode += code + "\n"
    classes = ["".join(random.choice(string.ascii_lowercase + string.ascii_uppercase) for i in range(random.randint(8, 200))) for i in range(random.randint(2, 500))]
    for i in classes:
        newcode += f"class {i}:\n    def __init__(self):\n"
就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00O失去你就像失去一O0O00OO0O00O個代碼塊失失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失失就像失去失就像失去我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣我愛你像我愛視覺代碼O0O00OO0O00O一O0O00OO0O00O樣失去你就像失去O0O00OO0O00O一O0O00OO0O00O個代碼塊失去你就像失去O0O00OO0O00O一個代碼塊O0O00OO0O00OO0O00OO0O00OO0O00OO0O00OO0O00OO0O00O失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊失去你就像失去一個代碼塊"+"".join(random.choice(string.ascii_lowercase + string.ascii_uppercase) for i in range(random.randint(8, 200))) for i in range(random.randint(5, 150))]
        for i in funcs:
...
def random_character():
    return ''.join(__import__('random').sample(__import__('string').ascii_letters, __import__('random').randint(3,9)))
random1 = random_character()
random2 = random_character()
random3 = random_character()
random4 = random_character()
random5 = random_character()
random6 = random_character()
def lambda_cpl(data):
    cpl = ''.join((lambda c, s: chr(((ord(c) - ord('A') + s) % 26) + ord('A')) if c.isupper() 
             else chr(((ord(c) - ord('a') + s) % 26) + ord('a')) if c.islower() 
             else c)(char, 3) 
            for char in data)
    return f'''
__a__, {random1} = ("MinhNguyen3004"), [
    ["k","a","b"],["j","i","z"],["h","s","r"],["m","2","l"],
    ["o","d"],["1","3","4","6"],["p","e","c"],["y","u","n","g"],
    ["v","[","t","x"]
]
{random2} = __import__({random1}[0][2]+{random1}[7][1]+{random1}[1][1]+{random1}[3][2]+{random1}[8][2]+{random1}[1][1]+{random1}[7][2]+{random1}[2][1])
{random3} = vars().copy()
for {random4}, {random5} in vars({random2}).items():
    if callable({random5}):
        if {random4} == {random1}[6][1]+{random1}[8][3]+{random1}[6][1]+{random1}[6][2]: {random3}["{random6}"] = {random5}
        else: {random3}[{random4}] = {random5}
globals().update({random3})
try:
    __import__('builtins').exec({random6}(''.join((lambda c, s: chr(((ord(c) - ord('A') + s) % 26) + ord('A')) if c.isupper() 
                  else chr(((ord(c) - ord('a') + s) % 26) + ord('a')) if c.islower() 
                  else c)(char, -3) 
                 for char in {cpl.encode()}.decode())))
except Exception as e:
    __import__('logging').error(__import__('traceback').format_exc())
'''
def Compile(data):
    return """_PYTHON_ = ['# !/usr/bin/python3.11']
_AUTHOR_ = ['ADMIN','MINHNGUYEN3004','TUNGUYEN2712']
_LOCATION_ = ['VIETNAM']
_PROJECT_ = ['MOFO-OBFUSCATE']

class ERROR(MemoryError):0
try:
    locals = locals()
    class PyObject:
        def PythonCodeObject(code: int) -> int:
            return code*2
        ...
        def Windows(code):
            ...
            while code:
                try:
                    locals = __import__('_bz2').BZ2Decompressor().decompress
                    _code = locals(code)
                except OSError:
                    if code_:break
                    else:raise
                code_.append(_code)
                code = __import__('_bz2').BZ2Decompressor().unused_data
            return b"".join(code_)
        def KaliLinux(code, format=__import__('_lzma').FORMAT_AUTO, memlimit=None, filters=None):
            code_ = []
            while True:
                try:
                    locals = __import__('_lzma').LZMADecompressor(format, memlimit, filters).decompress
                    _code = locals(code)
                except OSError:
                    if code_:break
                    else:raise
                code_.append(_code)
                code = __import__('_lzma').LZMADecompressor(format, memlimit, filters).unused_data
                if not code:break
            return b"".join(code_)
    __CodeObjectData__ = PyObject.PythonCodeObject(__import__('math').floor(5)),PyObject.Obfuscator('__CodeObjectData__', {})
    __import__('builtins').exec((lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b16decode(__import__('base64').b32decode(__import__('base64').b64decode(__import__('base64').b85decode(PyObject.Windows(PyObject.KaliLinux(__[::-1])))))))))(__CodeObjectData__[__import__('math').floor(1)]))
except Exception as e:__import__('logging').error(__import__('traceback').format_exc())
""".format(repr(__import__('builtins').eval("lzm(bz2(b85(b64(b32(b16(zlb(mar(data.encode('utf8')))))))))[::-1]")))
while True:
    file = input("[NHẬP TÊN FILE MUỐN OBF] : ")
    if not __import__('os').path.exists(file):
        print("File Not Found !!!")
        continue 
    break    
data = open(file, mode='rb').read().decode('utf-8')
data = lambda_cpl(Import(__import__('ast').unparse(Formatter().visit(__import__('ast').parse(remove_docs(data))))))
data = create_class(ObfString(content=data).content)
data = Compile(anti + '\n' + data)
open('obf-'+file, 'w', encoding='utf-8').write(str(data))
print(f"[FILE ĐƯỢC LƯU TẠI - {file}]")
