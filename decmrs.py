...
def loads(bytes):
    global {4}
    open('{{}}_dump/dump_{{}}_{{}}.py'.format('{0}',{4},'{0}'),'w').write("# Decode by MinhNguyen3004\n# File Name : [{0}.py] ({1} - {2})\n# Dump Count -> " + str({4}) + "\n\nexec(__import__('marshal').loads(" + str(bytes) + "))\n")
    print('\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]\033[1;97m >>\033[1;97m\033[1;91m\033[1;97m[\033[1;93m{{}}\033[1;97m] dump_file --\033[1;91m> \033[1;92m[{0}.py]\033[1;97m_\033[1;97m(\033[1;96mmarshal\033[1;97m)\033[1;97m!'.format({4}))
    {4} += 1
...
def compile(source, filename, mode, flags=0, dont_inherit=False, optimize=-1):
    ...
    try:
        ...
        pass
    open('{{}}_dump/dump_{{}}_{{}}_code.py'.format('{0}',{4},'{0}'),'w').write("""# Decode by MinhNguyen3004\n# File Name : [{0}.py] ({1} - {2})\n# Dump Count -> """ + str({4}) + """\n# This Is a Code String !\n\n""" + str(source) + """\n""")
    print('\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]\033[1;97m >>\033[1;97m\033[1;91m\033[1;97m[\033[1;93m{{}}\033[1;97m] dump_file --\033[1;91m> \033[1;92m[{0}.py]\033[1;97m_\033[1;97m(\033[1;96mcode\033[1;97m)\033[1;97m!'.format({4}))
    {4} += 1
...
marshal+=r'''
try:
    __import__('MinhNguyen3004').__spec__ = __import__('marshal').__spec__
    ...
    __import__('builtins').compile = __import__('MinhNguyen3004').compile
...
try:
    ...
    pass
try:
    exec('import marshal;exec(marshal.loads(' + str(__import__('marshal').dumps(compile(marshal, '<>', 'exec'))) + "), globals())",globals())
